...
<head>
	...
	<script type="text/javascript">
		...
		ls.lang.load({lang_load name="fav_add,fav_delete,comment_fold,comment_unfold,blog_more_hide,blog_more_view,topic_photoset_upload_close,vote_like,vote_dont_like,comment_subscribe,comment_unsubscribe"});
